const CACHE_NAME = 'rcem-qip-v3.14.0';
const STATIC_CACHE = 'rcem-qip-static-v3.14.0';
const DYNAMIC_CACHE = 'rcem-qip-dynamic-v3.14.0';
...
self.addEventListener('install', (event) => {
    console.log('[SW] Installing service worker v3.14.0...');
